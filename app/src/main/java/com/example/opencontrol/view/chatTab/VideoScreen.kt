...
@Composable
fun AgoraVideoScreen(
    onCallButtonClick: () -> Unit,
    onSwitchCameraButtonClick: () -> Unit,
    ...
    Box(modifier = Modifier.fillMaxSize()) {
        ...
        Column(
            ...
            Button(
                ...
                val callButtonIcon = if (isEndCall) {
                    Icons.Filled.Call
                } else {
                    Icons.Filled.CallEnd
                }
                Icon(callButtonIcon, contentDescription = null)
            }
            ...
            Row(
                ...
                Button(
                    onClick = { onSwitchCameraButtonClick() }
                ) {
                    Icon(Icons.Default.SwitchCamera, contentDescription = null)
                }

                Button(
                    onClick = { onMuteButtonClick() }
                ) {
                    val muteButtonIcon = if (isMuted) {
                        Icons.Filled.MicOff
                    } else {
                        Icons.Filled.Mic
                    }
                    Icon(muteButtonIcon, contentDescription = null)
                }
            }
        }
    }
